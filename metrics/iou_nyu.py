...
CLASS_LABELS = ['bed', 'books', 'ceil', 'chair', 'floor', 'furniture', 'object', 'picture', 'sofa', 'table', 'tv', 'wall', 'window']
UNKNOWN_ID = 255
...
def confusion_matrix(pred_ids, gt_ids):
    ...
    return np.bincount(pred_ids[idxs] * N_CLASSES + gt_ids[idxs], minlength=N_CLASSES*N_CLASSES).reshape((N_CLASSES, N_CLASSES)).astype(np.ulonglong)

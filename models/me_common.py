...
def get_norm(norm_type, n_channels, D, bn_momentum=0.1, affine=True):
  if norm_type == NormType.BATCH_NORM:
    return ME.MinkowskiBatchNorm(n_channels, momentum=bn_momentum, affine=affine)
